...
from .views import album_view, song_view, artist_view,song_artist_view,song_view_template
...
urlpatterns = [
    ...
    url(r'^get-songs-template/(?P<album_name>.*)/$', song_view_template, name='song_view_template'),
